...
TEMPLATE_NAME = "Ref_05_02_Video_Grok_15.md"
SOURCE_TEMPLATE_PATH = Path(__file__).resolve().parents[1] / "Reference" / "05_02" / "Video_Grok_15.md"
...
def build_prompt_package(context: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "talking_head_v1_05_02_video_prompt_grok_15_0.1",
        "prompt_type": "video_generation",
        "provider_profile": "video_grok_15",
        ...
        "template_blocks": [name for name in [
            "Video_Grok_15.FIRST_FRAME_ONLY",
            *positive_blocks,
            *negative_blocks,
            "VIDEO_GROK_PROMPT",
        ] if text_value(name)],
