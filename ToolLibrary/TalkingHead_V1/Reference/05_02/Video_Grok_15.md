# 05_02 Video Grok 1.5 Prompt Template / Max 1.5 X 提示词模板

Scope: xAI `grok-imagine-video-1.5-preview` / Max 1.5 X only.

中文用于维护；英文 `OPENCREW:*` 块由 `video_grok_15.py` 读取并进入模型调用。
