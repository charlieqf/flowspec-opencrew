...
TOOL_NAME = "06_01_VideoPlanComposer"
TOOL_VERSION = "0.1.0"
TOOL_DIR_NAME = "S10_06_01_VideoPlanComposer"
...
def parse_args(argv: list[str]) -> Args:
    ...
    parser.add_argument("--subtitle-mode", choices=["hyperframe", "none"], default="hyperframe")
