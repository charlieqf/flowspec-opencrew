...
TOOL_ID = "06_02_ShotPlan_PlanA_SceneImageSelect"
TOOL_NAME = "06_02_ShotPlan_PlanA_SceneImageSelect"
TOOL_VERSION = "1.0.0"
TOOL_LEVEL = "shotplan"
CHILD_TOOL_ID = "06_02_Shot_PlanA_SceneImageSelect"
CHILD_SCRIPT = Path(__file__).with_name(f"{CHILD_TOOL_ID}.py")
REQUIRES = ["rebuild_shot_plan.json"]
PRODUCES = ["reports/plan_a/06_02_ShotPlan_PlanA_SceneImageSelect.json"]
SUGGESTED_PREVIOUS_TOOLS = ['06_01_ShotPlan_PlanA_SceneImageRebuild']
