...
TOOL_ID = "06_01_ShotPlan_PlanA_SceneImageRebuild"
TOOL_NAME = "06_01_ShotPlan_PlanA_SceneImageRebuild"
TOOL_VERSION = "1.0.0"
TOOL_LEVEL = "shotplan"
CHILD_TOOL_ID = "06_01_Shot_PlanA_SceneImageRebuild"
CHILD_SCRIPT = Path(__file__).with_name(f"{CHILD_TOOL_ID}.py")
REQUIRES = ["rebuild_shot_plan.json"]
PRODUCES = ["reports/plan_a/06_01_ShotPlan_PlanA_SceneImageRebuild.json"]
SUGGESTED_PREVIOUS_TOOLS = ['04_02_ShotPlan_FirstLastFrameConfirm', '05_01_ShotPlan_ScenePromptRefresh']
SUGGESTED_NEXT_TOOLS = ['06_02_ShotPlan_PlanA_SceneImageSelect']
