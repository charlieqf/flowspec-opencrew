...
TOOL_ID = "08_01_Shot_PlanA_ImageSequenceClipPlan"
TOOL_NAME = "08_01_Shot_PlanA_ImageSequenceClipPlan"
TOOL_VERSION = "1.0.0"
TOOL_LEVEL = "shot"
CHILD_TOOL_ID = "08_01_Scene_PlanA_ImageSequenceClipPlan"
CHILD_SCRIPT = Path(__file__).with_name(f"{CHILD_TOOL_ID}.py")
REQUIRES = ["rebuild_shot_plan.json"]
PRODUCES = ["reports/plan_a/08_01_Shot_PlanA_ImageSequenceClipPlan.json"]
SUGGESTED_PREVIOUS_TOOLS = ['06_02_Shot_PlanA_SceneImageSelect', '07_03_Shot_PlanA_TTSTimelineValidate']
