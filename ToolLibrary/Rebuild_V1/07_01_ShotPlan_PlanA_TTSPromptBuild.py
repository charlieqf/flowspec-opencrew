...
TOOL_ID = "07_01_ShotPlan_PlanA_TTSPromptBuild"
TOOL_NAME = "07_01_ShotPlan_PlanA_TTSPromptBuild"
TOOL_VERSION = "1.0.0"
TOOL_LEVEL = "shotplan"
CHILD_TOOL_ID = "07_01_Shot_PlanA_TTSPromptBuild"
CHILD_SCRIPT = Path(__file__).with_name(f"{CHILD_TOOL_ID}.py")
REQUIRES = ["rebuild_shot_plan.json"]
PRODUCES = ["reports/plan_a/07_01_ShotPlan_PlanA_TTSPromptBuild.json"]
SUGGESTED_PREVIOUS_TOOLS = ['05_01_ShotPlan_ScenePromptRefresh']
SUGGESTED_NEXT_TOOLS = ['07_02_ShotPlan_PlanA_TTSGenerateAndLock']
