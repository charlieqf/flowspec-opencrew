...
TOOL_ID = "08_02_ShotPlan_PlanA_HyperframeSubtitleAlign"
TOOL_NAME = "08_02_ShotPlan_PlanA_HyperframeSubtitleAlign"
TOOL_VERSION = "1.0.0"
TOOL_LEVEL = "shotplan"
CHILD_TOOL_ID = "08_02_Shot_PlanA_HyperframeSubtitleAlign"
CHILD_SCRIPT = Path(__file__).with_name(f"{CHILD_TOOL_ID}.py")
REQUIRES = ["rebuild_shot_plan.json"]
PRODUCES = ["reports/plan_a/08_02_ShotPlan_PlanA_HyperframeSubtitleAlign.json"]
SUGGESTED_PREVIOUS_TOOLS = ['08_01_ShotPlan_PlanA_ImageSequenceClipPlan']
SUGGESTED_NEXT_TOOLS = ['08_03_ShotPlan_PlanA_ImageSequenceCompose']
